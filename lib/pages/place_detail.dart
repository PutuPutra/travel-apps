                  ...
                  children: [
                    PageView(
                      ...
                      children: List.generate(
                        ...
                        (index) {
                          String imageUrl = widget.destination.image![index];
                          if (imageUrl.startsWith('http')) {
                            // Jika gambar adalah URL, gunakan Image.network
                            return Image.network(
                              imageUrl,
                              fit: BoxFit.cover,
                            );
                          } else {
                            // Jika gambar adalah file lokal, gunakan Image.asset
                            return Image.asset(
                              imageUrl,
                              fit: BoxFit.cover,
                            );
                              ...
                              image: DecorationImage(
                                image: widget.destination.image!.length - 1 !=
                                    ...
                                    ? (widget.destination.image![pageView + 1]
                                        ...
                                        : AssetImage(widget.destination.image![pageView + 1])
                                            as ImageProvider
                                    : (widget.destination.image![0].startsWith('http') ||
                                            widget.destination.image![0]
                                                .startsWith('https'))
                                        ? NetworkImage(
                                            widget.destination.image![0])
                                        : AssetImage(widget.destination.image![0])
                                            as ImageProvider,
                                fit: BoxFit.cover,
                              ),
                            ),
